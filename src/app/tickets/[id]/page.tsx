...
const TicketDetailsPage=async (props: {
  ...
  return (
    <div className="min-h-screen bg-orange-50 p-8">
      ...
      border border-gray-200 p-8 space-y-6">
        <h1 className="text-3xl font-bold text-orange-600">{ticket.subject}</h1>
        ...
        <Link
        href='/tickets'
        className='inline-block bg-orange-600 text-white px-4 py-2
        rounded hover:bg-orange-700 transition'
        >
          <FaArrowLeft
